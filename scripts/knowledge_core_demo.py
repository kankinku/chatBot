"""Knowledge Core demo entry point."""
...
from chatbot.knowledge.validation import ValidationPipeline
from chatbot.knowledge.validation.models import ValidationDestination
from chatbot.knowledge.domain import DomainPipeline
from chatbot.knowledge.reasoning import ReasoningPipeline
from chatbot.knowledge.bootstrap import build_llm_client
from chatbot.knowledge.settings import get_settings
from chatbot.knowledge.shared.logging_setup import setup_logging
...
def run_pipeline(use_llm: bool, llm_client):
    ...
    sample_path = get_settings().resolve_path("data/ontology/samples/sample_documents.json")
    ...
    if not documents:
        print("No sample documents. Add documents to data/ontology/samples/sample_documents.json.")
        return reasoning
