...
VIEWS_PATH = REPO_ROOT / "services" / "gateway" / "chatbot_proxy" / "views.py"
MODELS_PATH = REPO_ROOT / "services" / "gateway" / "chatbot_proxy" / "models.py"
MIGRATION_PATH = (
    REPO_ROOT
    / "services"
    / "gateway"
...
URLS_PATH = REPO_ROOT / "services" / "gateway" / "chatbot_backend" / "urls.py"
