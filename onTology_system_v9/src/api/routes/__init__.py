...
from src.api.routes.fundamental_routes import router as fundamental_router
...
api_router.include_router(pair_router, prefix="/pairs", tags=["Pair Trading"])
api_router.include_router(fundamental_router, prefix="/fundamental", tags=["Fundamental Analysis"])
