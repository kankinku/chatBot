...
from chatbot.core.types import Chunk, Answer
from chatbot.core.logger import get_logger
from chatbot.core.exceptions import PipelineInitError, PipelineExecutionError
from chatbot.embedding.factory import create_embedder
from chatbot.retrieval.hybrid_retriever import HybridRetriever
from chatbot.generation.answer_generator import AnswerGenerator
from chatbot.analysis.question_analyzer import QuestionAnalyzer
from chatbot.filtering.context_filter import ContextFilter
from chatbot.filtering.deduplicator import Deduplicator
from chatbot.filtering.guardrail import GuardrailChecker
from chatbot.reranking.reranker import Reranker
...
class RAGPipeline:
    ...
    def __init__(
        ...
        try:
            ...
            # 답변 생성기 생성
            from chatbot.generation.llm_client import OllamaClient
            llm_client = OllamaClient(self.model_config.llm)
            
            # 평가 모드에 따라 PromptBuilder 생성
            from chatbot.generation.prompt_builder import PromptBuilder
