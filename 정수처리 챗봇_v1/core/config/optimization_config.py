...
class OptimizationConfig:
    ...
    def _adjust_for_environment(self):
        ...
        if self.environment == "development":
            ...
            # self.cache.sql_cache_size = 50  # SQL 캐시 제거됨
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "cache": {
                ...
                # "sql_cache_size": self.cache.sql_cache_size,  # SQL 캐시 제거됨
                ...
                # "sql_cache_ttl": self.cache.sql_cache_ttl,  # SQL 캐시 TTL 제거됨
