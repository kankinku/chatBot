...
class CompanyConfig:
    ...
    def _load_company_info(self) -> Dict:
        ...
        default_info = {
            "name": get_config("COMPANY_NAME", "범용 RAG 시스템"),
            "description": get_config("COMPANY_DESCRIPTION", "문서 검색 및 데이터베이스 쿼리 시스템"),
            "tagline": get_config("COMPANY_TAGLINE", "지능형 문서 검색 및 데이터 분석"),
            "role": get_config("COMPANY_ROLE", "문서 검색, 데이터 분석, AI 답변 생성"),
            "services": [
                "문서 검색",
                "데이터베이스 쿼리", 
                "AI 답변 생성",
            ...
            "location": get_config("COMPANY_LOCATION", ""),
            "website": get_config("COMPANY_WEBSITE", ""),
            "email": get_config("COMPANY_EMAIL", ""),
            "system_type": get_config("SYSTEM_TYPE", "범용 RAG 시스템"),
            "target_users": [
                "시스템 관리자",
                "데이터 분석가", 
                "사용자",
