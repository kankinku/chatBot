...
# 개선된 모듈들
from chatbot.generation.async_llm_client import AsyncOllamaClient
from chatbot.generation.batch_answer_generator import BatchAnswerGenerator
from chatbot.embedding.batch_embedder import BatchEmbedder
from chatbot.embedding.sbert_embedder import SBERTEmbedder
from chatbot.monitoring.metrics import get_metrics
from chatbot.quality.answer_quality_checker import AnswerQualityChecker
from chatbot.filtering.adaptive_context_selector import AdaptiveContextSelector
...
async def demo_batch_generation():
    ...
    from chatbot.core.types import Chunk, RetrievedSpan
